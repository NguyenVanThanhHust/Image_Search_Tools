...
def get_training_dataloader(mean, std, batch_size=32, num_workers=4, shuffle=True):
    ...
    #/home/doannn/Documents/Working_Server/datasets/cifar100_imgs/train   /home/doannn/Documents/Working_Server/datasets/SealDataset_TrainValTest/train
...
def get_test_dataloader(mean, std, batch_size=32, num_workers=4, shuffle=True):
    ...
    # /media/doannguyen950/data/Projects/Works/SealProject/Datasets/data_from_internet/cifar100_imgs
